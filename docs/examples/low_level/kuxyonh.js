function brogue2(小韻號) {
	...
	if
	(  in母(小韻號, '幫滂並明'.split('')) && in等(小韻號, '一二三四'.split(''))
	|| in母(小韻號, '端透定泥'.split('')) && in等(小韻號, '一四'.split(''))
	|| in母(小韻號, '知徹澄孃'.split('')) && in等(小韻號, '二三'.split(''))
	|| in母(小韻號, '精清從心邪'.split('')) && in等(小韻號, '一三四'.split(''))
	|| in母(小韻號, '莊初崇生俟'.split('')) && in等(小韻號, '二三'.split(''))
	|| in母(小韻號, '章昌船書常'.split('')) && in等(小韻號, '三'.split(''))
	|| in母(小韻號, '見溪疑'.split('')) && in等(小韻號, '一二三四'.split(''))
	|| in母(小韻號, '羣'.split('')) && in等(小韻號, '二三'.split(''))
	|| in母(小韻號, '影曉'.split('')) && in等(小韻號, '一二三四'.split(''))
	|| in母(小韻號, '匣'.split('')) && in等(小韻號, '一二四'.split(''))
	|| in母(小韻號, '云以'.split('')) && in等(小韻號, '三'.split(''))
	|| in母(小韻號, '來'.split('')) && in等(小韻號, '一二三四'.split(''))
	|| in母(小韻號, '日'.split('')) && in等(小韻號, '三'.split(''))
	)
		隔音符號 = '';
