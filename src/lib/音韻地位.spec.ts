...
test('韻圖母 & 等', t => {
  t.is(音韻地位.from描述('幫三C凡入').韻圖母, '非', '輕脣音');
  t.is(音韻地位.from描述('幫三B真平').韻圖母, '幫', '重脣音');
  t.is(音韻地位.from描述('常開三清平').韻圖母, '禪', '照三（母）');
  t.is(音韻地位.from描述('常開三清平').韻圖等, '三', '照三（等）');
  t.is(音韻地位.from描述('生開三庚平').韻圖母, '審', '照二（母）');
  ...
  t.is(音韻地位.from描述('云合三C虞平').韻圖母, '喻', '喻三（母）');
  t.is(音韻地位.from描述('云合三C虞平').韻圖等, '三', '喻三（等）');
  t.is(音韻地位.from描述('以合三虞平').韻圖母, '喻', '喻四（母）');
