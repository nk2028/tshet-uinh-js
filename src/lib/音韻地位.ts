 ...
 */
export function validate(母: string, 呼: string, 等: string, 重紐: string, 韻: string, 聲: string): void {
 ...
 * ```
 */
export function encode(母: string, 呼: string, 等: string, 重紐: string, 韻: string, 聲: string): string {
 ...
 * ```
 */
export function decode(音韻編碼: string): 音韻地位 {
